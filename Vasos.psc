Algoritmo Vasos
	Definir mano_derecha, mano_izquierda Como Cadena
	Definir vaso_A, vaso_B, vaso_C Como Cadena
	vaso_A <- 'Jugo de naranja'
	vaso_B <- 'Agua'
	vaso_C <- 'Vacío'
	mano_derecha <- 'Libre'
	mano_izquierda <- 'Libre'
	Escribir 'Extiendes tus manos, coges el Vaso A con la derecha y el Vaso C con la izquierda.'
	...
	vaso_C <- vaso_A
	vaso_A <- 'Vacío'
	Escribir 'Sueltas el Vaso A dejándolo sobre la mesa.'
	mano_derecha <- 'Libre'
